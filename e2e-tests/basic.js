...
const groupLink = `https://swishh.tech/id#${groupName}`
...
const startAppAndCreateAccount = async caps => {
	...
	await pressButton(driver, 'Start using swishh')
...
const joinGroupFromHome = async (driver, link) => {
	...
	await pressButton(driver, 'Open Swishh Link')
