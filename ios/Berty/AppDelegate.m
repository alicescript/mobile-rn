...
#import "Swishh-Swift.h" // needed for swift
...
RCTRootView *rootView = [self.reactDelegate createRootViewWithBridge:bridge
  ...
  if (@available(iOS 13.0, *)) {
    ...
    [[LifeCycle getSharedInstance] registerBackgroundTaskWithIdentifier:@"tech.swishh.ios.task.gobridge-process"];
    [[LifeCycle getSharedInstance] registerBackgroundTaskWithIdentifier:@"tech.swishh.ios.task.gobridge-refresh"];
  } else {
...
{
  if (@available(iOS 13.0, *)) {
    [[LifeCycle getSharedInstance] scheduleBackgroundProcessingWithIdentifier:@"tech.swishh.ios.task.gobridge-process"];
    [[LifeCycle getSharedInstance] scheduleAppRefreshWithIdentifier:@"tech.swishh.ios.task.gobridge-refresh"];
  }
...
{
  NSString *payload = notification.request.content.userInfo[SwishhbridgeServicePushPayloadKey];
