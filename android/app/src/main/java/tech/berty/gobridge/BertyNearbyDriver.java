...
import swishhbridge.Swishhbridge;
import swishhbridge.ProximityDriver;

import java.io.File;
import java.nio.charset.StandardCharsets;

import swishhbridge.ProximityTransport;
import tech.swishh.gobridge.nearbydriver.base.NearbyDriver;
...
public class SwishhNearbyDriver implements ProximityDriver {
    private static final String TAG = "bty.NearbyDriver";

    private static final String SERVICE_ID = "tech.swishh.bty.nearby";
    ...
    UserConnectionCallback userConnectionCallback = new UserConnectionCallback() {
        ...
        public void onConnectionResult(final String endpointId, String endpointName, boolean isConnected) {
            ...
            if (isConnected) {
                Log.i(TAG, "Connected");
                // inform SwishhBridge that there is a new connection
    ...
    public SwishhNearbyDriver(Context context) {
    ...
    public void start(String localPID) {
        ...
        mTransport = Swishhbridge.getProximityTransport(ProtocolName);
        if (mTransport == null) {
