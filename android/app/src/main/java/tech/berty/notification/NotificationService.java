package tech.swishh.notification;
...
import swishhbridge.FormatedPush;
import swishhbridge.PushConfig;
import swishhbridge.PushStandalone;
import tech.swishh.android.MainActivity;
import tech.swishh.android.MainApplication;
import tech.swishh.gobridge.GoBridgeModule;
import tech.swishh.gobridge.KeystoreDriver;
import tech.swishh.gobridge.LoggerDriver;
...
public class NotificationService extends FirebaseMessagingService {
    ...
    private final static LoggerDriver logger = new LoggerDriver("tech.swishh.notif", "gomobile");
    ...
    public void onMessageReceived(@NonNull RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getData().size() > 0) {
            ...
            String data = remoteMessage.getData().get(Swishhbridge.ServicePushPayloadKey);
            if (data != null) {
                try {
