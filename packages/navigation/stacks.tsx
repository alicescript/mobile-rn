...
import { useAppDispatch, useThemeColor } from '@swishh/hooks'
import { selectHandledLink, setHandledLink } from '@swishh/redux/reducers/ui.reducer'
import * as RawComponents from '@swishh/screens'
...
const DeepLinkBridge: React.FC = React.memo(() => {
	...
	useEffect(() => {
		if (!handledLink && url && !error && !(url as string).startsWith('swishh://services-auth')) {
...
export const Navigation: React.FC = React.memo(() => {
	...
	return (
		...
		>
			...
			/>
			<NavigationStack.Screen
				name='Settings.AboutSwishh'
				component={Components.Settings.AboutSwishh}
				options={{
					headerStyle: {
						backgroundColor: colors['secondary-background'],
					},
			...
			/>
			<NavigationStack.Screen
				name='Settings.MySwishhId'
				component={Components.Settings.MySwishhId}
				options={BackgroundHeaderScreenOptions({
					title: t('settings.my-swishh-ID.title'),
					...CustomTitleStyle(),
					presentation: 'formSheet',
				})}
			/>
