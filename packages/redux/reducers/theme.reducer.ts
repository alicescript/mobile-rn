...
import darkTheme from '@swishh/assets/themes/dark-theme.json'
import darkLFTheme from '@swishh/assets/themes/DarkLF-theme.json'
import defaultTheme from '@swishh/assets/themes/default-theme.json'
import pinkTheme from '@swishh/assets/themes/pink-theme.json'
import { randomizeThemeColor } from '@swishh/contexts/styles'
...
enum AVAILABLE_THEMES {
	DEFAULT_SWISHH_THEME = 'default-swishh-theme',
...
const initialState: ThemeState = {
	selected: AVAILABLE_THEMES.DEFAULT_SWISHH_THEME,
	collection: {
		[AVAILABLE_THEMES.DEFAULT_SWISHH_THEME]: { colors: defaultTheme },
...
const slice = createSlice({
	...
	reducers: {
		...
		deleteAddedThemes(theme: ThemeState) {
			theme.selected = AVAILABLE_THEMES.DEFAULT_SWISHH_THEME
