...
const swishhOperatedServer = 'https://services-v1.swishh.tech/'
...
export const servicesAuthViaDefault = async (
	...
	return servicesAuthViaURL(protocolClient, swishhOperatedServer, services)
}
...
const servicesAuthViaURL = async (
	...
	let responseURL
	try {
		// TODO remove &scope=psh suffix when we want to propose more swishh services
