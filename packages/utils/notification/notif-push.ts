...
import { GRPCError } from '@swishh/grpc-bridge'
import { ServiceClientType } from '@swishh/grpc-bridge/welsh-clients.gen'
import { PushTokenRequester } from '@swishh/native-modules/PushTokenRequester'
import rnutil from '@swishh/utils/react-native'
import { getPermissions } from '@swishh/utils/react-native/permissions'
...
export const pushFilteringAvailable =
	Platform.OS === 'android' ||
	(Platform.OS === 'ios' && Application.applicationId === 'tech.swishh.ios')
