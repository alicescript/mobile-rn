...
import { prepareMediaBytes } from '@swishh/utils/messenger/media'
...
const Item: React.FC<{
	...
	const userDisplayName =
		(conversation.type === beapi.messenger.Conversation.Type.MultiMemswishhpe
...
export const ForwardToSwishhContactModal: React.FC<{
	image: beapi.messenger.IMedia & {
		uri?: string
	}
	onClose: () => void
