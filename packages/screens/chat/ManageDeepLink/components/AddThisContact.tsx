...
import { SecondaryButton, TabBar } from '@swishh/components'
...
import { dispatch as navDispatch } from '@swishh/navigation/rootRef'
...
const AddThisContact: React.FC<{
	...
	const { call: requestContact, error, done } = swishhMethodsHooks.useContactRequest()
