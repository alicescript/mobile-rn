...
import { swishhMethodsHooks, useAppDispatch, useConversation, useThemeColor } from '@swishh/hooks'
...
export const ManageGroupInvitation: React.FC<{
	...
	const { call: joinConversation, done, error } = swishhMethodsHooks.useConversationJoin()
