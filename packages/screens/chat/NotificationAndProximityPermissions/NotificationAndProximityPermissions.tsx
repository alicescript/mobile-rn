...
import { useAppDispatch, useAppSelector, useThemeColor } from '@swishh/hooks'
...
import {
	...
	acquirePermission,
	getPermissions,
} from '@swishh/utils/react-native/permissions'
...
export const NotificationAndProximityPermissions: ScreenFC<
