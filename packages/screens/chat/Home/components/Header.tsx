...
import { MediumClearableInput } from '@swishh/components'
...
import { useProfileNotification, useThemeColor } from '@swishh/hooks'
						...
						>
							...
							>
								<LottieView
									ref={animate}
									style={{ width: 40 }}
									source={require('@swishh/assets/lottie/swishh_logo_animated.json')}
									loop={false}
								/>
							</TouchableOpacity>
						</View>
