...
import { ButtonSetting, FactionButtonSetting } from '@swishh/components/shared-components'
...
import {
	...
	serviceTypes,
} from '@swishh/utils/remote-services/remote-services'
	...
	return (
		<View style={[flex.tiny, padding.medium, margin.bottom.medium]}>
			...
			<ButtonSetting
				...
				iconColor={colors['background-header']}
				alone={true}
				// onPress={() => navigation.navigate('Settings.SwishhServices')}
			/>
		</View>
	)
}
