...
const BodyTermsOfUse: React.FC<{}> = () => {
	...
	return (
		...
		>
			<BodyTermsOfUseItem
				textProps='Swishh Technologies (“Swishh”) utilizes state-of-the-art security and end-to-end encryption to
			...
			<BodyTermsOfUseItem
				...
				textProps='Swishh does not sell, rent or monetize your personal data or content in any way – ever.'
			/>
			<BodyTermsOfUseItem
