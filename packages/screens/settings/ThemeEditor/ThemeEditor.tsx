...
import { TextualDropdown } from '@swishh/components'
import { FloatingMenuItemWithIcon } from '@swishh/components'
...
import {
	...
	selectThemeSelected,
	setTheme,
} from '@swishh/redux/reducers/theme.reducer'
import { createAndSaveFile, getPath } from '@swishh/utils/react-native/file-system'
