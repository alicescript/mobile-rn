...
import { selectProtocolClient, selectSelectedAccount } from '@swishh/redux/reducers/ui.reducer'
...
} from '@swishh/utils/notification/notif-push'
import { checkProximityPermission } from '@swishh/utils/react-native/checkPermissions'
import { serviceTypes } from '@swishh/utils/remote-services/remote-services'
			...
			>
				...
				>
					...
					<TouchableOpacity
						...
						onPress={() => navigate('Settings.MySwishhId')}
					>
						<Icon
							name='qr'
							pack='custom'
...
export const SettingsHome: ScreenFC<'Settings.Home'> = withInAppNotification(
	({ showNotification }: any) => {
		...
		const {
			...
			call: systemInfoCall,
		} = swishhMethodsHooks.useSystemInfo()
					...
					>
						...
						<ItemSection>
							...
							<MenuItemWithIcon
								...
								onPress={() => navigate('Settings.AboutSwishh')}
							>
