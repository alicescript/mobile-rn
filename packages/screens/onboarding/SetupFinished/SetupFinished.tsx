...
const SetupFinishedBody = () => {
	...
	return isAccount ? (
		<>
			{isFinished && (
				<LottieView
					source={require('@swishh/assets/lottie/confetti-lottie.json')}
					autoPlay
					loop={false}
					style={{
						position: 'absolute',
			...
			<View style={{ flex: 4 }}>
				...
				{!isFinished &&
					(!isGenerated ? (
						<>
							<LottieView
								source={require('@swishh/assets/lottie/Swishh_onboard_animation_assets2/Startup animation assets/Circle spin.json')}
								autoPlay
								loop={false}
							/>
							<LottieView
								source={require('@swishh/assets/lottie/Swishh_onboard_animation_assets2/Startup animation assets/Code Generated.json')}
								autoPlay
								loop={false}
								onAnimationFinish={() => {
									setIsGenerated(true)
						...
						<LottieView
							source={require('@swishh/assets/lottie/Swishh_onboard_animation_assets2/Startup animation assets/Finish appear.json')}
							autoPlay
							loop={false}
						/>
					))}
		...
		<>
			<View style={{ flex: 4 }}>
				...
				{isGeneration === 1 && (
					<LottieView
						source={require('@swishh/assets/lottie/Swishh_onboard_animation_assets2/Startup animation assets/Code generation row 1.json')}
						autoPlay
						loop={false}
						speed={2}
						onAnimationFinish={() => {
				...
				{isGeneration === 2 && (
					<LottieView
						source={require('@swishh/assets/lottie/Swishh_onboard_animation_assets2/Startup animation assets/Code generation row 2.json')}
						autoPlay
						loop={false}
						speed={2}
						onAnimationFinish={() => {
				...
				{isGeneration === 3 && (
					<LottieView
						source={require('@swishh/assets/lottie/Swishh_onboard_animation_assets2/Startup animation assets/Code generation row 3.json')}
						autoPlay
						loop={false}
						speed={2}
						onAnimationFinish={() => {
				...
				{isGeneration === 4 && (
					<LottieView
						source={require('@swishh/assets/lottie/Swishh_onboard_animation_assets2/Startup animation assets/Code generation row 4.json')}
						autoPlay
						loop={false}
						speed={2}
						onAnimationFinish={() => {
