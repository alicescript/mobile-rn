...
export interface IMessengerServiceMock {
	InstanceShareableSwishhID: UnaryMock<
		beapi.messenger.InstanceShareableSwishhID.IRequest,
		beapi.messenger.InstanceShareableSwishhID.IReply
	>
	ShareableSwishhGroup: UnaryMock<
		beapi.messenger.ShareableSwishhGroup.IRequest,
		beapi.messenger.ShareableSwishhGroup.IReply
	>
	DevShareInstanceSwishhID: UnaryMock<
		beapi.messenger.DevShareInstanceSwishhID.IRequest,
		beapi.messenger.DevShareInstanceSwishhID.IReply
	>
