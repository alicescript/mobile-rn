...
export interface WelshMessengerServiceClient {
	instanceShareableSwishhID: UnaryType<
		beapi.messenger.MessengerService['instanceShareableSwishhID']
	>
	shareableSwishhGroup: UnaryType<beapi.messenger.MessengerService['shareableSwishhGroup']>
	devShareInstanceSwishhID: UnaryType<beapi.messenger.MessengerService['devShareInstanceSwishhID']>
