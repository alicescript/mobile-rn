		...
		nested: {
			account: {
				nested: {
					v1: {
						options: {
							go_package: 'swishh.tech/swishh/go/pkg/accounttypes',
							...
							OpenAccountWithProgress: {
								...
								nested: {
									...
									Reply: {
										fields: {
											progress: {
												type: 'swishh.protocol.v1.Progress',
												id: 1,
											},
										},
									},
			...
			push: {
				nested: {
					v1: {
						options: {
							go_package: 'swishh.tech/swishh/go/pkg/pushtypes',
							'(gogoproto.marshaler_all)': true,
							'(gogoproto.unmarshaler_all)': true,
							'(gogoproto.sizer_all)': true,
						},
			...
			protocol: {
				nested: {
					v1: {
						options: {
							go_package: 'swishh.tech/swishh/go/pkg/protocoltypes',
			...
			bridge: {
				nested: {
					v1: {
						options: {
							go_package: 'swishh.tech/swishh/go/pkg/swishhbridge',
							'(gogoproto.marshaler_all)': true,
							'(gogoproto.unmarshaler_all)': true,
							'(gogoproto.sizer_all)': true,
						},
			...
			errcode: {
				options: {
					go_package: 'swishh.tech/swishh/go/pkg/errcode',
					'(gogoproto.goproto_enum_prefix_all)': false,
					'(gogoproto.marshaler_all)': true,
					'(gogoproto.unmarshaler_all)': true,
					'(gogoproto.sizer_all)': true,
			...
			messenger: {
				nested: {
					v1: {
						options: {
							go_package: 'swishh.tech/swishh/go/pkg/messengertypes',
						...
						nested: {
							MessengerService: {
								methods: {
									InstanceShareableSwishhID: {
										requestType: 'InstanceShareableSwishhID.Request',
										responseType: 'InstanceShareableSwishhID.Reply',
									},
									ShareableSwishhGroup: {
										requestType: 'ShareableSwishhGroup.Request',
										responseType: 'ShareableSwishhGroup.Reply',
									},
									DevShareInstanceSwishhID: {
										requestType: 'DevShareInstanceSwishhID.Request',
										responseType: 'DevShareInstanceSwishhID.Reply',
									},
									DevStreamLogs: {
								...
								nested: {
									Encrypted: {
										fields: {
											...
											groupType: {
												type: 'swishh.protocol.v1.GroupType',
												id: 23,
											},
											groupSignPub: {
												type: 'bytes',
							...
							AppMessage: {
								...
								nested: {
									...
									MonitorMetadata: {
										fields: {
											event: {
												type: 'swishh.protocol.v1.MonitorGroup.EventMonitor',
												id: 1,
											},
										},
									},
							...
							SystemInfo: {
								...
								nested: {
									...
									Reply: {
										fields: {
											protocol: {
												type: 'swishh.protocol.v1.SystemInfo.Reply',
												id: 1,
											},
											messenger: {
												type: 'Messenger',
									...
									Messenger: {
										fields: {
											process: {
												type: 'swishh.protocol.v1.SystemInfo.Process',
												id: 1,
											},
											warns: {
												rule: 'repeated',
							...
							Interaction: {
								fields: {
									...
									member: {
										...
										options: {
											'(gogoproto.moretags)':
												'gorm:foreignKey:PublicKey;references:MemberPublicKey',
										},
									},
									conversationPublicKey: {
										type: 'string',
							...
							Member: {
								fields: {
									...
									devices: {
										...
										options: {
											'(gogoproto.moretags)':
												'gorm:foreignKey:MemberPublicKey;references:PublicKey',
										},
									},
								},
							},
