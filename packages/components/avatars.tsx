...
import GroupAvatar from '@swishh/assets/images/Avatar_Group_Copy_19.png'
import OrangeBotAvatar from '@swishh/assets/images/swishh_bot_orange_bg.png'
import PinkBotAvatar from '@swishh/assets/images/swishh_bot_pink_bg.png'
import BlueDevAvatar from '@swishh/assets/images/swishh_dev_blue_bg.png'
import GreenDevAvatar from '@swishh/assets/images/swishh_dev_green_bg.png'
import Logo from '@swishh/assets/logo/1_swishh_picto.svg'
import { useStyles } from '@swishh/contexts/styles'
import { useAccount, useContact, useConversation, useMember, useThemeColor } from '@swishh/hooks'
import { navigate } from '@swishh/navigation'
import { selectPersistentOptions } from '@swishh/redux/reducers/persistentOptions.reducer'
...
const hardcodedAvatars = {
	swishh_dev_green_bg: GreenDevAvatar,
	swishh_bot_pink_bg: PinkBotAvatar,
	swishh_dev_blue_bg: BlueDevAvatar,
	swishh_bot_orange_bg: OrangeBotAvatar,
...
export const ConversationAvatar: React.FC<{
	...
	if (conv) {
		if (conv.type === beapi.messenger.Conversation.Type.MultiMemswishhpe) {
