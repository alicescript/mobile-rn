...
import { useAppDispatch, useConversationMembers, useMessengerClient } from '@swishh/hooks'
import { useNavigation } from '@swishh/navigation'
import { getPeerFromMemberPK, PeerNetworkStatus } from '@swishh/redux/reducers/messenger.reducer'
			...
			<View style={styles.barWidth}>
				{animationStep === 0 && (
					<LottieView
						...
						source={require('@swishh/assets/lottie/network_status_animations/orange.json')}
				...
				{animationStep === 1 && (
					<LottieView
						autoPlay
						style={styles.lottieWidth}
						source={require('@swishh/assets/lottie/network_status_animations/blue.json')}
