...
import { BottomModal } from '@swishh/components/modals'
...
import { setActiveReplyInteraction } from '@swishh/redux/reducers/chatInputs.reducer'
import { selectInteraction } from '@swishh/redux/reducers/messenger.reducer'
import { InteractionUserMessage, ParsedInteraction } from '@swishh/utils/api'
import { pbDateToNum } from '@swishh/utils/convert/time'
import { getMediaTypeFromMedias } from '@swishh/utils/messenger/media'
...
// We have delete this component cause unusable but we can find it here if we need: https://github.com/swishh/swishh/blob/38913ed828/js/packages/components/chat/message/Reactions.tsx
// and a component dependencie https://github.com/swishh/swishh/blob/38913ed828f11799bb5f4471d1cb31dc182d9ed5/js/packages/components/shared-components/AnimatedNumber.tsx
...
export const UserMessage: React.FC<{
	...
	const isGroup = convKind === beapi.messenger.Conversation.Type.MultiMemswishhpe
