...
export type MessengerMethodsHooks = {
	useInstanceShareableSwishhID: () => {
		error: any
		call: (req?: beapi.messenger.InstanceShareableSwishhID.IRequest) => void
		reply: beapi.messenger.InstanceShareableSwishhID.IReply | null
		done: boolean
		called: boolean
		loading: boolean
	}
	useShareableSwishhGroup: () => {
		error: any
		call: (req?: beapi.messenger.ShareableSwishhGroup.IRequest) => void
		reply: beapi.messenger.ShareableSwishhGroup.IReply | null
		done: boolean
		called: boolean
		loading: boolean
	}
	useDevShareInstanceSwishhID: () => {
		error: any
		call: (req?: beapi.messenger.DevShareInstanceSwishhID.IRequest) => void
		reply: beapi.messenger.DevShareInstanceSwishhID.IReply | null
		done: boolean
		called: boolean
		loading: boolean
	}
